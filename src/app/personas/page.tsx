        ...
        <section className="mb-16">
          <div className="gradient-primary text-white rounded-2xl p-8 md:p-12">
            ...
            <p className="text-xl mb-8 text-blue-50 leading-relaxed font-arabic max-w-4xl">
              محتوى مصمم خصيصاً لتلبية احتياجات كل شريحة من شركاء التربية
              الدامجة. اختر فئتك لاكتشاف المسارات والموارد المناسبة لك.
            </p>
            <div className="grid md:grid-cols-4 gap-6">
              {personas.map((persona, index) => {
                ...
                return (
                  <div
                    key={index}
                    className="bg-white/10 backdrop-blur-sm rounded-lg p-6 text-center hover:bg-white/20 transition-colors duration-200 cursor-pointer"
                  >
                    <Icon className="h-12 w-12 mx-auto mb-3 text-yellow-300" />
                    <div className="font-bold font-arabic text-lg">
                      {persona.title}
                    </div>
                  </div>
                );
          ...
          <div className="space-y-12">
            {personas.map((persona, index) => {
              ...
              return (
                <div
                  key={index}
                  className={`bg-linear-to-r ${persona.backgroundColor} rounded-2xl p-8 border-2 ${persona.borderColor}`}
                >
                  <div className="flex items-center space-x-reverse space-x-6 mb-8">
                    <div
                      className={`w-20 h-20 bg-linear-to-r ${persona.color} rounded-full flex items-center justify-center shadow-lg`}
                    >
                  ...
                  {/* Pathways Section */}
                  <div>
                    <h3 className="text-xl font-bold mb-6 font-arabic text-gray-800">
                      مساراتك المتخصصة:
                    </h3>
                        ...
                        >
                          ...
                          <div className="space-y-3">
                            {pathway.steps.map((step, j) => (
                              ...
                              >
                                <span
                                  className="w-8 h-8 bg-linear-to-r text-white rounded-full flex items-center justify-center text-sm font-bold shrink-0"
                                  style={{
                                    background:
                                      "linear-gradient(to right, #005F99, #27AE60)",
                                  }}
                                >
                                  {j + 1}
                                </span>
            ...
            {[
              {
                ...
                category: "الأسر",
                content:
                  "المسارات المخصصة ساعدتني على فهم حقوقي وخطوات عملية لدمج طفلي بنجاح في المدرسة العادية.",
                rating: 5,
              },
              {
                ...
                category: "المديرون",
                content:
                  "مشروع المؤسسة الدامجة وفر لنا خطة واضحة وقابلة للتطبيق. النتائج كانت مذهلة.",
                rating: 5,
              },
              {
                persona: "فاطمة، مدرسة",
                category: "المدرسون",
                content:
                  "استراتيجيات تدبير الفروق وتخطيط الحصص غيرت طريقي في التعليم. أصبحت أكثر ثقة وفعالية.",
                rating: 5,
              },
              {
                ...
                category: "الجمعيات",
                content:
                  "حملات التوعية والمناصرة أصبحت أكثر تنظيماً وفعالية بفضل الأدوات المتاحة.",
                rating: 5,
              },
        ...
        <section className="text-center">
          <div className="bg-gray-100 text-gray-800 rounded-2xl p-12">
            <h2 className="text-3xl font-bold mb-6 font-arabic">
              هل أنت حديث العهد بمجال التربية الدامجة؟
            </h2>
            <p className="text-xl mb-8 text-blue-800 font-arabic leading-relaxed max-w-2xl mx-auto">
              ابدأ بفهم الأساسيات ثم اختر المسار المناسب لك. نحن هنا لدعمك في كل
              خطوة.
            </p>
