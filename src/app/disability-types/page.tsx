...
import { ArrowLeft, Users, Brain, Eye, Ear, Accessibility, BookOpen, ChevronRight, Heart, AlertCircle } from 'lucide-react'
...
export default function DisabilityTypes() {
  const disabilityTypes = [
    {
      ...
      learningStyle: 'تعتمد على الوسائل البصرية والسمعية، مع تكييف المكان والأنشطة',
      teacherSupport: [
    ...
    },
    {
      ...
      learningStyle: 'تعتمد بشكل كبير على الوسائل البصرية والتواصل بالإشارة والكتابة',
      teacherSupport: [
        'استخدام وسائل بصرية',
    ...
    },
    {
      ...
      learningStyle: 'تعتمد على الوسائل السمعية واللمسية، مع استخدام تقنيات برايل',
      teacherSupport: [
    ...
    },
    {
      ...
      learningStyle: 'تعتمد على التكرار والتعلم العملي، مع تقسيم المهام إلى خطوات بسيطة',
      teacherSupport: [
  ...
  const socialRepresentation = {
    ...
    content: [
      {
        type: 'التمثل الطبي',
        description: 'نظرة تركز على العجز ونقص الفرد، وتعتبر الإعاقة مشكلة طبية بحتة',
      ...
      {
        type: 'التمثل الحقوقي',
        description: 'نظرة تعتبر الإعاقة جزءاً من التنوع البشري وحق أساسي في المشاركة',
  ...
  const differenceBetweenDisabilityAndDeficiency = {
    ...
    disability: {
      ...
      definition: 'القيود التي يواجهها الفرد في المشاركة الكاملة بسبب التفاعل بين القصور والحواجز البيئية',
      examples: ['صعوبة الوصول إلى المدرسة', 'عدم القدرة على المشاركة في الأنشطة', 'الحاجز في التواصل'],
        ...
        <section className="mb-16">
          <div className="gradient-secondary text-white rounded-2xl p-8 md:p-12">
            ...
            <p className="text-xl mb-8 text-green-50 leading-relaxed font-arabic max-w-4xl">
              فهم أنواع الإعاقة والقصور يساعدنا على توفير الدعم المناسب لكل طفل، وخلق بيئة تعليمية دامجة تراعي احتياجات الجميع.
            </p>
          </div>
        </section>
          ...
          <div className="grid md:grid-cols-2 gap-8">
            <div className="bg-blue-50 rounded-xl p-8 border-2 border-blue-200">
              ...
              <div className="bg-white rounded-lg p-4 mb-4">
                ...
                <ul className="space-y-1">
                  {differenceBetweenDisabilityAndDeficiency.deficiency.examples.map((example, i) => (
                    <li key={i} className="text-gray-700 font-arabic text-sm">• {example}</li>
                  ))}
                </ul>
              </div>
              <p className="text-sm font-arabic text-blue-700 font-medium">
                المستوى: {differenceBetweenDisabilityAndDeficiency.deficiency.level}
              </p>
            </div>
            ...
            <div className="bg-green-50 rounded-xl p-8 border-2 border-green-200">
              ...
              <div className="bg-white rounded-lg p-4 mb-4">
                <p className="text-sm font-arabic text-gray-600 mb-2">أمثلة:</p>
                <ul className="space-y-1">
                  {differenceBetweenDisabilityAndDeficiency.disability.examples.map((example, i) => (
                    <li key={i} className="text-gray-700 font-arabic text-sm">• {example}</li>
                  ))}
                </ul>
              </div>
              <p className="text-sm font-arabic text-green-700 font-medium">
                المستوى: {differenceBetweenDisabilityAndDeficiency.disability.level}
              </p>
            </div>
          </div>
        </section>
        ...
        <section className="mb-16">
          ...
          <div className="space-y-8">
            {disabilityTypes.map((type, index) => {
              ...
              return (
                <div key={index} className={`border-2 rounded-xl p-8 ${type.color}`}>
                  ...
                  <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-6">
                    <div className="bg-white rounded-lg p-4">
                      <h4 className="font-bold font-arabic text-gray-800 mb-3">الخصائص:</h4>
                      <ul className="space-y-2">
                        {type.characteristics.map((char, i) => (
                          <li key={i} className="flex items-start space-x-reverse space-x-2">
                            ...
                            <span className="text-gray-700 font-arabic text-sm">{char}</span>
                          </li>
                        ))}
                      </ul>
                    </div>
                    ...
                    <div className="bg-white rounded-lg p-4">
                      <h4 className="font-bold font-arabic text-gray-800 mb-3">أسلوب التعلم:</h4>
                    ...
                    <div className="bg-white rounded-lg p-4">
                      <h4 className="font-bold font-arabic text-gray-800 mb-3">دعم المدرس:</h4>
                      <ul className="space-y-2">
                        {type.teacherSupport.map((support, i) => (
                          <li key={i} className="flex items-start space-x-reverse space-x-2">
                            <ChevronRight className="h-4 w-4 text-blue-500 mt-0.5 shrink-0" />
                            <span className="text-gray-700 font-arabic text-sm">{support}</span>
                          </li>
                        ))}
                      </ul>
                    </div>
                    ...
                    <div className="bg-white rounded-lg p-4">
                      <h4 className="font-bold font-arabic text-gray-800 mb-3">دعم الأسرة:</h4>
                      <ul className="space-y-2">
        ...
        <section className="text-center">
          <div className="bg-linear-to-r from-primary to-secondary text-white rounded-2xl p-12">
            ...
            <p className="text-xl mb-8 text-blue-800 font-arabic leading-relaxed max-w-2xl mx-auto">
              استكشف أدلتنا المتخصصة للمدرسين والأسر للحصول على استراتيجيات عملية وأدوات فعالة
            </p>
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
              <Link href="/teachers-guide" className="button-primary bg-white text-primary hover:bg-gray-100">
                دليل المدرسين
              </Link>
