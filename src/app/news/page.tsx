...
import { ArrowLeft, Calendar, Clock, MapPin, Users, Star, Heart, MessageCircle, Search, Filter, ChevronRight, Award, BookOpen, Target } from 'lucide-react'
  ...
  const newsItems = [
    {
      ...
      excerpt: 'برنامج تكويني متكامل يهدف إلى تأهيل 500 مدرس في مجال التربية الدامجة على المستوى الوطني',
      content: 'أطلقت وزارة التربية الوطنية بالتعاون مع الشركاء الدوليين برنامجاً جديداً لتكوين المدرسين في مجال التربية الدامجة...',
    ...
    },
    {
      ...
      image: '/api/placeholder/400/250',
      excerpt: 'تجربة رائدة في جهة الدار البيضاء سطات تثبت نجاح الدمج المدرسي للأطفال ذوي الإعاقة',
      content: 'أظهرت النتائج الأولية لتجربة دمج الأطفال ذوي الإعاقة في المدارس العمومية بجهة الدار البيضاء سطات نجاحاً كبيراً...',
      tags: ['نجاح', 'دمج', 'أطفال'],
      featured: true,
      views: 3890
    },
    {
      ...
      location: 'مراكش',
      image: '/api/placeholder/400/250',
      excerpt: 'ندوة تجمع الخبراء والممارسين لمناقشة مستقبل التربية الدامجة في المغرب',
      content: 'نظمت وزارة التربية الوطنية بالتعاون مع منظمة اليونسكو ندوة وطنية حول التحديات وفرص التربية الدامجة...',
    ...
    },
    {
      ...
      location: 'البيضاء',
      image: '/api/placeholder/400/250',
      excerpt: 'توزيع معدات تكنولوجية مساعدة لدعم الطلاب ذوي الإعاقة في المؤسسات التعليمية',
      content: 'في إطار برنامج دعم التربية الدامجة، تم توزيع معدات تكنولوجية مساعدة على 100 مؤسسة تعليمية...',
    ...
    },
    {
      ...
      location: 'فاس',
      image: '/api/placeholder/400/250',
      excerpt: 'ورشة عمل تدريبية لتأهيل المصممين التربويين في مجال المناهج الدامجة',
      content: 'نظمت المديرية العامة للمناهج ورشة عمل حول تصميم المناهج الدامجة بمشاركة 50 مصمماً تربوياً...',
    ...
    },
    {
      ...
      location: 'طنجة',
      image: '/api/placeholder/400/250',
      excerpt: 'انطلاق حملة وطنية للتوعية بأهمية التربية الدامجة وحقوق الأطفال ذوي الإعاقة',
      content: 'انطلقت الحملة الوطنية للتوعية بالتربية الدامجة تحت شعار "الدمج حق للجميع" في عدة مدن مغربية...',
  ...
  const upcomingEvents = [
    {
      ...
      location: 'الرباط',
      type: 'مؤتمر',
      description: 'مؤتمر دولي يجمع الخبراء من مختلف دول العالم لمناقشة أحدث التوجهات في التربية الدامجة',
      registration: true,
      participants: 500
    },
    {
      ...
      location: 'الدار البيضاء',
      type: 'ورشة عمل',
      description: 'ورشة عملية حول استخدام التقنيات المساعدة في دعم الطلاب ذوي الإعاقة',
      registration: true,
      participants: 50
    },
    {
      ...
      location: 'مراكش',
      type: 'يوم دراسي',
      description: 'يوم دراسي للمدرسين حول استراتيجيات إدارة الفصول الدامجة بفعالية',
      registration: true,
      participants: 100
    }
  ]
  ...
  const successStories = [
    {
      ...
      excerpt: 'قصة طفلة توحدي تم دمجها بنجاح في المدرسة العادية وتفوقت دراسياً',
      content: 'سارة طفلة في التاسعة من عمرها، تم تشخيصها بالتوحد في سن الثالثة. بفضل الدعم الأسري والمدرسي المناسب...',
      tags: ['توحد', 'نجاح', 'تفوق'],
      rating: 5
    },
    {
      ...
      content: 'مدرسة النصر الابتدائية بالدار البيضاء بدأت رحلتها نحو التربية الدامجة قبل ثلاث سنوات...',
    ...
    },
    {
      ...
      content: 'أمين طالب في السادسة ابتدائي، كان يعاني من صعوبات في القراءة والكتابة. بفضل الدعم المناسب...',
  ...
  return (
    <div className="min-h-screen">
      ...
      <main className="container-custom section-padding">
        ...
        <section className="mb-16">
          <div className="gradient-primary text-white rounded-2xl p-8 md:p-12">
            ...
            <p className="text-xl mb-8 text-blue-50 leading-relaxed font-arabic max-w-4xl">
              تابع آخر المستجدات والفعاليات في مجال التربية الدامجة. قصص نجاح، تكوينات، لقاءات، وأنشطة تهدف إلى تعزيز الدمج المدرسي.
            </p>
                ...
                <div className="p-6">
                  ...
                  <div className="flex items-center justify-between">
                    <div className="flex flex-wrap gap-2">
                      {item.tags.map((tag, i) => (
                        <span key={i} className="bg-gray-100 text-gray-700 px-2 py-1 rounded text-xs font-arabic">
                          #{tag}
                        </span>
                      ))}
                    </div>
                    <button className="text-primary hover:text-primary/80 font-arabic text-sm flex items-center space-x-reverse space-x-1">
        ...
        <section className="mb-8">
          <div className="flex flex-wrap justify-center gap-3">
            {categories.map((category) => (
              <button
                key={category.value}
                className={`px-4 py-2 rounded-full font-arabic transition-colors duration-200 ${
                  category.value === 'all'
        ...
        <section className="mb-16">
          ...
          <div className="grid md:grid-cols-3 gap-8">
            {upcomingEvents.map((event) => (
              <div key={event.id} className="bg-linear-to-br from-blue-50 to-green-50 rounded-xl p-8 border-2 border-blue-200">
                ...
                {event.registration && (
                  <button className="w-full bg-primary text-white py-3 rounded-lg hover:bg-primary/90 transition-colors duration-200 font-arabic">
                    التسجيل في الفعالية
                  </button>
                )}
              </div>
        ...
        <section className="mb-16">
          ...
          <div className="grid md:grid-cols-3 gap-8">
            {successStories.map((story) => (
              <div key={story.id} className="bg-white rounded-xl shadow-lg overflow-hidden hover:shadow-xl transition-shadow duration-200">
                <div className="aspect-video bg-gray-200 relative">
                  <div className="absolute top-4 left-4">
                ...
                <div className="p-6">
                    ...
                    <div className="flex items-center">
                      {[...Array(5)].map((_, i) => (
                        <Star
                          key={i}
                          className={`h-4 w-4 ${
                            i < story.rating ? 'text-yellow-500 fill-current' : 'text-gray-300'
                          }`}
                        />
                      ))}
                    </div>
                  ...
                  <div className="flex flex-wrap gap-2 mb-4">
                    {story.tags.map((tag, i) => (
                      <span key={i} className="bg-green-100 text-green-700 px-2 py-1 rounded text-xs font-arabic">
                        #{tag}
                      </span>
                    ))}
                  </div>
                  <button className="w-full bg-green-500 text-white py-2 rounded-lg hover:bg-green-600 transition-colors duration-200 font-arabic text-sm">
                    اقرأ القصة الكاملة
                  </button>
                </div>
              </div>
        ...
        {/* Newsletter Signup */}
        <section className="mb-16">
          <div className="bg-linear-to-r from-primary to-secondary text-white rounded-2xl p-12 text-center">
            <h2 className="text-3xl font-bold mb-6 font-arabic">
              اشترك في نشرتنا الإخبارية
            </h2>
            <p className="text-xl mb-8 text-blue-100 font-arabic leading-relaxed max-w-2xl mx-auto">
              احصل على آخر الأخبار والفعاليات وقصص النجاح مباشرة في بريدك الإلكتروني
            </p>
            <form className="max-w-md mx-auto flex flex-col sm:flex-row gap-4">
              <input
                type="email"
                placeholder="بريدك الإلكتروني"
                className="flex-1 px-6 py-3 rounded-lg text-gray-800 placeholder-gray-500 focus:outline-none focus:ring-4 focus:ring-white/30 font-arabic"
              />
              <button
                type="submit"
