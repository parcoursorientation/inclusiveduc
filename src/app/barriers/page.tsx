...
import { ArrowLeft, Shield, Users, Building, AlertTriangle, CheckCircle, Lightbulb, Target, BookOpen, GraduationCap } from 'lucide-react'
      ...
      barriers: [
        {
          ...
          examples: ['عدم وجود وسائل نقل مناسبة', 'طرق غير آمنة', 'تكلفة النقل الباهظة']
        },
        {
          title: 'غياب الولوجيات',
          description: 'عدم تكييف البنية التحتية لاستقبال جميع الأطفال',
          examples: ['سلالم بدون مصاعد', 'أبواب ضيقة', 'دورات مياه غير متاحة', 'فصول دراسية غير مناسبة']
        },
        {
      ...
      barriers: [
        {
          ...
          examples: ['الاعتقاد بأن الإعاقة عقاب', 'تقليل من قدرات الأطفال', 'الخوف من الإعاقة']
        },
        {
          title: 'التنميط',
          description: 'وضع جميع الأطفال ذوي الإعاقة في قالب واحد',
          examples: ['الاعتقاد بأنهم جميعاً متشابهون', 'تجاهل الفروق الفردية', 'تعميم الصفات السلبية']
        },
        {
          title: 'الأحكام المسبقة',
          description: 'آراء مسبقة لا تستند إلى حقائق',
          examples: ['الاعتقاد بعدم جدوى التعليم', 'توقع الفشل', 'عدم الثقة في القدرات']
        }
      ]
    },
    {
      ...
      barriers: [
        {
          ...
          examples: ['محتوى موحد للجميع', 'طرق تدريس واحدة', 'تقييمات غير مناسبة', 'غياب التكييفات']
        },
        {
          title: 'نقص التكوين',
          description: 'ضعف تأهيل المدرسين للتعامل مع التنوع',
          examples: ['غياب التكوين في التربية الدامجة', 'عدم معرفة استراتيجيات الدعم', 'قلة الموارد التعليمية']
        },
        {
          title: 'غياب الأدوات',
          description: 'نقص الموارد والوسائل المساعدة',
          examples: ['عدم وجود أخصائيين', 'قلة الموارد التعليمية', 'غياب التقنيات المساعدة']
        }
      ]
    }
  ]
      ...
      <main className="container-custom section-padding">
        ...
        <nav className="mb-8" aria-label="الرابط التشعبي">
          <ol className="flex items-center space-x-reverse space-x-2 text-sm">
            ...
            <li className="text-gray-600 font-arabic">الحواجز المانعة للتمدرس</li>
          </ol>
        </nav>
        ...
        <section className="mb-16">
          <div className="gradient-primary text-white rounded-2xl p-8 md:p-12">
            ...
            <p className="text-xl mb-8 text-blue-50 leading-relaxed font-arabic max-w-4xl">
              تحديد الحواجز التي تعيق تمدرس الأطفال في وضعية إعاقة واقتراح حلول عملية للتغلب عليها، بناءً على الأدلة الرسمية للتربية الدامجة.
            </p>
          </div>
        </section>
        ...
        <section className="mb-16">
          ...
          <div className="space-y-8">
            {barrierCategories.map((category, index) => {
              ...
              return (
                <div key={index} className={`border-2 rounded-xl p-8 ${category.color}`}>
                    ...
                    {category.barriers.map((barrier, i) => (
                      <div key={i} className="bg-white rounded-lg p-6 shadow-md">
                        ...
                        <div className="bg-gray-50 rounded-lg p-4">
                          <p className="text-sm font-arabic text-gray-700 mb-2">أمثلة:</p>
                          <ul className="space-y-1">
                            {barrier.examples.map((example, j) => (
                              <li key={j} className="text-gray-600 font-arabic text-sm flex items-start space-x-reverse space-x-2">
        ...
        <section className="mb-16">
          ...
          <div className="space-y-8">
            {solutions.map((solutionCategory, index) => {
              ...
              return (
                <div key={index} className="bg-linear-to-r from-green-50 to-blue-50 rounded-xl p-8">
                  <div className="flex items-center space-x-reverse space-x-4 mb-6">
                    <div className="w-16 h-16 bg-white rounded-full flex items-center justify-center shadow-md">
                      ...
                      <div key={i} className="bg-white rounded-lg p-6 shadow-md">
                        ...
                        <div className="space-y-2">
                          {solution.actions.map((action, j) => (
                            <div key={j} className="flex items-start space-x-reverse space-x-2">
            ...
            {practicalStrategies.map((strategy, index) => (
              <div key={index} className="bg-white rounded-xl p-8 shadow-lg border-2 border-gray-200">
                ...
                <div className="bg-blue-50 rounded-lg p-4">
                  <h4 className="font-bold font-arabic text-gray-800 mb-3">الخطوات العملية:</h4>
        ...
        <section className="text-center">
          <div className="bg-linear-to-r from-primary to-secondary text-white rounded-2xl p-12">
            ...
            <p className="text-xl mb-8 text-blue-800 font-arabic leading-relaxed max-w-2xl mx-auto">
              استكشف أدلتنا المتخصصة للحصول على استراتيجيات وأدوات عملية لتحقيق بيئة تعليمية دامجة
            </p>
