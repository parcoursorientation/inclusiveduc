  ...
  const awarenessCampaign = {
    ...
    stages: [
      ...
      },
      {
        ...
        activities: ["استبيانات", "مقابلات", "تحليل البيانات", "تقرير نهائي"],
      },
    ],
  };
        ...
        <section className="mb-16">
          <div className="gradient-secondary text-white rounded-2xl p-8 md:p-12">
            ...
            <p className="text-xl mb-8 text-green-50 leading-relaxed font-arabic max-w-4xl">
              دليل شامل لدعم الأسر والجمعيات في رحلة دمج الأطفال ذوي الإعاقة.
              يحتوي على استراتيجيات عملية للوالدية الإيجابية، بناء المشروع
              الأسري، والتعبئة الاجتماعية.
            </p>
        ...
        <section className="text-center">
          <div className="bg-gray-100 text-gray-800 rounded-2xl p-12">
            ...
            <p className="text-xl mb-8 text-blue-800 font-arabic leading-relaxed max-w-2xl mx-auto">
              استكشف مواردنا المتخصصة واحصل على الدعم اللازم لتحقيق نجاح طفلك في
              بيئة تعليمية دامجة
            </p>
